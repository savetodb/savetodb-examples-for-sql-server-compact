# SaveToDB Examples for SQL Server Compact

SaveToDB examples show various features of the applications built with SQL Server Compact and the following client apps:
...
Such samples use [SaveToDB Framework for SQL Server Compact](https://github.com/savetodb/savetodb-framework-for-sql-server-compact).
...
To install or uninstall the example, edit the setup connection string in the gsqlcmd.exe.config file and run `dbsetup`. Then follow command-line instructions.
